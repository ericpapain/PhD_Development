...
float C[produit_finis][sites_prod_interne][period_planif]=...; 		// cout unitaire de production du produit p dans le site k a la periode t
float S[produit_finis][sites_prod_interne][period_planif]=...; 		// cout de lancement de la prod du produit P dans le site de prod K durant la periode de planification T
float G[produit_finis][sites_prod_sous_traitant][period_planif]=...; 		// cout de sous traitance du produit P chez le site du sous traitant V durant la periode T
float CSU[sites_prod_interne][period_planif]=...; 					// cout de sous utilisation  de la cpté interne de production dans le site de production K durant la période T
